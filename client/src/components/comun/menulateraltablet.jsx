...
export default function MenuLateralTablet({proporcional}) {
    ...
    return (
        <div className='position-fixed start-0 shadow' style={{width: '100%', height: '100%', background: 'rgba(89, 89, 89, 0.5)', top: 180 / proporcional, zIndex: 99999}}>
                ...
                <div style={{width: '60%', height: '100%', background: 'rgba(255, 255, 255, 0.6)'}}>
                    <div style={{width: '100%', height: 80 / proporcional, padding: 20 / proporcional, paddingRight: 40 / proporcional, paddingLeft: 40 / proporcional}}>
                        <p style={{fontSize: 18 / proporcional, fontWeight:  seleccion_menu === 'inicio' ? 700 : 600, lineHeight: `${40 / proporcional}px`, color: 'rgb(89, 89, 89)', 
                            ...
                            <a href='/#' style={{textDecoration: 'none', color: 'rgb(89, 89, 89)'}}
                    ...
                    <div style={{width: '100%', height: 80 / proporcional, padding: 20 / proporcional, paddingRight: 40 / proporcional, paddingLeft: 40 / proporcional}}>
                        <p style={{fontSize: 18 / proporcional, fontWeight:  seleccion_menu === 'nosotros' ? 700 : 600, lineHeight: `${40 / proporcional}px`, color: 'rgb(89, 89, 89)', 
                            ...
                            <a href='/#nosotros' style={{textDecoration: 'none', color: 'rgb(89, 89, 89)'}}
                                onClick={() => dispatch(set_open_menu_main(false))}>Sobre nosotros</a>
                        </p>
                    </div>
                    <div style={{width: '100%', height: 80 / proporcional, padding: 20 / proporcional, paddingRight: 40 / proporcional, paddingLeft: 40 / proporcional}}>
                        <p style={{fontSize: 18 / proporcional, fontWeight:  seleccion_menu === 'clientes' ? 700 : 600, lineHeight: `${40 / proporcional}px`, color: 'rgb(89, 89, 89)', 
                            ...
                            <a href='/#clientes' style={{textDecoration: 'none', color: 'rgb(89, 89, 89)'}}
                                onClick={() => dispatch(set_open_menu_main(false))}>Nuestros clientes</a>
                        </p>
                    </div>
                    <div style={{width: '100%', height: 80 / proporcional, padding: 20 / proporcional, paddingRight: 40 / proporcional, paddingLeft: 40 / proporcional}}>
                        <p style={{fontSize: 18 / proporcional, fontWeight:  seleccion_menu === 'productos' ? 700 : 600, lineHeight: `${40 / proporcional}px`, color: 'rgb(89, 89, 89)', 
                            ...
                            <a href='/#productos' style={{textDecoration: 'none', color: 'rgb(89, 89, 89)'}}
                                onClick={() => dispatch(set_open_menu_main(false))}>Nuestros productos</a>
                        </p>
                    </div>
                    <div style={{width: '100%', height: 80 / proporcional, padding: 20 / proporcional, paddingRight: 40 / proporcional, paddingLeft: 40 / proporcional}}>
                        <p style={{fontSize: 18 / proporcional, fontWeight:  seleccion_menu === 'contacto' ? 700 : 600, lineHeight: `${40 / proporcional}px`, color: 'rgb(89, 89, 89)', 
                            ...
                            <a href='/#contacto' style={{textDecoration: 'none', color: 'rgb(89, 89, 89)'}}
                                onClick={() => dispatch(set_open_menu_main(false))}>Contácto</a>
                        </p>
                    </div>
                    <div className='rounded-pill' style={{width: '90%', height: 2 / proporcional, background: 'rgb(51, 51, 51)', marginLeft: '5%',  marginRight: '5%', marginBottom: 20 / proporcional}}/>
                    <div className='d-flex justify-content-end' style={{width: '100%', height: 40 / proporcional, paddingRight: 40 / proporcional}}>
                        ...
                        <a href='https://www.twitter.com' target='_blank' style={{width: 'auto', height: 'auto', marginRight: 10 / proporcional}}>
                            <img src={twitter} style={{width: 40 / proporcional, height: 40 / proporcional, padding: 5 / proporcional}}
                                onClick={() => dispatch(set_open_menu_main(false))}/>
                        </a>
