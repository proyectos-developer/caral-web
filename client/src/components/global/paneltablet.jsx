    ...
    return (
        <div className='position-relative' style={{width: '100%', height: 'auto'}}>
            ...
            <div className={boton_whatsapp ? 'position-fixed shadow-lg rounded-circle' : 'position-fixed shadow rounded-circle'} 
                ...
                <a href='https://wa.me/51944914016?text=Hola,%20vi%20tu%20página%20web%20y%20me%20gustaría%20mas%20información%20sobre%20tus%20productos.' target='_blank' rel='noopener noreferrer'>
