...
export default function Informacion({proporcional}) {
    ...
    return (
        <div className='position-absolute start-50 translate-middle' style={{width: '100%', height: 'auto', top: '38%'}}>
            ...
            <div style={{width: '100%', height: 'auto'}}>
                ...
                <div className='d-flex' style={{width: '100%', height: 30 / proporcional, marginBottom: 20 / proporcional}}>
                    ...
                    <p style={{fontSize: 20 / proporcional, fontWeight:  600, lineHeight: `${30 / proporcional}px`, color: '#20294e', fontFamily: 'Open Sans',
                        marginBottom: 20 / proporcional, cursor: 'pointer', textAlign: 'left'}}>
