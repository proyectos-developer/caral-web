        ...
        <div className='' style={{width: '100%', height: 'auto', paddingTop: 60 / proporcional, paddingBottom: 60 / proporcional}}>
            <div id='productos' className='' style={{width: '100%', height: 'auto'}}>
                ...
                <div className='d-flex' style={{width: '100%', height: 'auto'}}>
                    <img src={producto_07} style={{width: '25%', height: '25%'}}/>
                    <img src={producto_01} style={{width: '25%', height: '25%'}}/>
                    <img src={producto_02} style={{width: '25%', height: '25%'}}/>
                    <img src={producto_03} style={{width: '25%', height: '25%'}}/>
                </div>
                <div className='d-flex' style={{width: '100%', height: 'auto'}}>
