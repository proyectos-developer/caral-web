...
import producto_08 from '../../assets/image/home/producto_09.png'
        ...
        <div id='productos' className='' style={{width: '100%', height: 'auto', paddingTop: 200 / proporcional, paddingBottom: 200 / proporcional}}>
            <div className='' style={{width: '100%', height: 'auto'}}>
                ...
                <div className='d-flex' style={{width: '100%', height: 'auto'}}>
                    <img src={producto_07} style={{width: '100%', height: '100%'}}/>
                </div>
                <div className='d-flex' style={{width: '100%', height: 'auto'}}>
                    <img src={producto_01} style={{width: '100%', height: '100%'}}/>
                </div>
                <div className='d-flex' style={{width: '100%', height: 'auto'}}>
                    <img src={producto_02} style={{width: '100%', height: '100%'}}/>
                </div>
                <div className='d-flex' style={{width: '100%', height: 'auto'}}>
                    <img src={producto_03} style={{width: '100%', height: '100%'}}/>
                </div>
                <div className='d-flex' style={{width: '100%', height: 'auto'}}>
                    <img src={producto_04} style={{width: '100%', height: '100%'}}/>
                </div>
                <div className='d-flex' style={{width: '100%', height: 'auto'}}>
                    <img src={producto_05} style={{width: '100%', height: '100%'}}/>
                </div>
                <div className='d-flex' style={{width: '100%', height: 'auto'}}>
                    <img src={producto_06} style={{width: '100%', height: '100%'}}/>
                </div>
                <div className='d-flex' style={{width: '100%', height: 'auto'}}>
                    <img src={producto_08} style={{width: '100%', height: '100%'}}/>
                </div>
            </div>
        </div>
    )
